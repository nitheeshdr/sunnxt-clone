...
import { getShortsCarouselInfo } from "@/lib/api";
...
export default async function ShortsPage() {
  ...
  try {
    const res = await getShortsCarouselInfo();
  ...
  return (
    <div className="bg-[#0f0f0f] min-h-screen">
      <div className="px-8 py-6 max-w-350 mx-auto">
        <h1 className="text-2xl font-bold text-white mb-1">Shorts</h1>
        <p className="text-gray-400 text-sm">Short clips & highlights</p>
      </div>
